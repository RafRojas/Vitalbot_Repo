...
OPENAI_API_KEY= "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"
...
<div style="text-align: center;">
    <h3>🫀<i> Hi there! I'm VitalBot, I'm here to help. </i> 🤖</h3>
</div>
...
- Today's date is {current_date}, keep this into account when you make the appointments.
---
...
2. If the user mentions self-harm or suicidal thoughts:
   - Respond urgently with support:  
     "Please contact emergency services or a suicide prevention hotline immediately. You’re not alone, and there are people ready to help. Would you like me to connect you with an specialist for further support?"
...
"Your tests are scheduled for **January 16, 2025 at 2 PM** at...**. I’ve also scheduled an appointment with **Dr...**, your assigned GP, on **January 20, 2025 at 10 AM** at **Sanitas Zarzuela Hospital**. Does this schedule work for you?"
